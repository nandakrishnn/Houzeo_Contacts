...
class ContactServices {
  ...
  Stream<QuerySnapshot> getUserContactDetails() {
    return FirebaseFirestore.instance.collection('UserContacts').snapshots();
  }
  ...
  Stream<QuerySnapshot> getUserContactFavDetails() {
    return FirebaseFirestore.instance.collection('UserFavourites').snapshots();
  }
}
